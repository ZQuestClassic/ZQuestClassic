...
editbox$(PLATEXT).o: eb_intern.h editbox.c editbox.h zc_alleg.h
	$(CC) $(OPTS) $(CFLAG) -c editbox.c -o editbox$(PLATEXT).o $(SFLAG) $(WINFLAG)
editbox-zq$(PLATEXT).o: eb_intern.h editbox.c editbox.h zc_alleg.h
...
zquest$(PLATEXT).o: colors.h editbox.h fontsdat.h gui.h items.h jwin.h jwinfsel.h load_gif.h midi.h qst.h save_gif.h sprite.h subscr.h tab_ctl.h tiles.h zc_alleg.h zcmusic.h zdefs.h zq_class.h zq_cset.h zq_custom.h zq_doors.h zq_files.h zq_init.h zq_misc.h zq_rules.h zq_subscr.h zq_tiles.h zqscale.h zquest.cpp zquest.h zquestdat.h zsys.h
