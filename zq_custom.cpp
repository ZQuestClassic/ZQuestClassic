...
const char *counterlist(int index, int *list_size)
{
	if (index >= 0) {
	  ...
	  switch(index) {
		case 0: return "None";
		case 1: return "Life";
		case 2: return "Rupees";
		case 3: return "Bombs";
		case 4: return "Arrows";
		case 5: return "Magic";
		case 6: return "Keys";
		case 7: return "Super Bombs";
...
const char *defenselist(int index, int *list_size)
{
  if(index>=0)
  {
	...
	{
	  default: return "(None)";
	  case edHALFDAMAGE: return "1/2 Damage";
	  case edQUARTDAMAGE: return "1/4 Damage";
	  case edSTUNONLY: return "Stun";
	  case edSTUNORCHINK: return "Stun Or Block";
	  case edSTUNORIGNORE: return "Stun Or Ignore";
	  case edCHINKL1: return "Block If < 1";
	  case edCHINKL2: return "Block If < 2";
	  case edCHINKL4: return "Block If < 4";
	  case edCHINKL6: return "Block If < 6";
	  case edCHINKL8: return "Block If < 8";
	  case edCHINK: return "Block";
	  case edIGNOREL1: return "Ignore If < 1";
	  case edIGNORE: return "Ignore";
	  case ed1HKO: return "One-Hit-Kill";
	}
  }
  *list_size = edLAST;
  return NULL;
...
static EnemyNameInfo enameinf[]=
{
  ...
  { eeMOLD, { "Segments:",  NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL  },
			{ NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL } },
  { eeWIZZ, { "Walk Style:",  "Shot Type:", "Shot Attr. 1:", NULL, "Teleport Delay:", NULL, NULL, NULL, NULL, NULL  },
