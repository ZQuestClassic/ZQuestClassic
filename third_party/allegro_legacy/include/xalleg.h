...
AL_LEGACY_FUNCPTR (int, _xwin_window_creator, (void));
AL_LEGACY_FUNCPTR (void, _xwin_window_defaultor, (void));
AL_LEGACY_FUNCPTR (void, _xwin_window_redrawer, (int, int, int, int));
AL_LEGACY_FUNCPTR (void, _xwin_input_handler, (void));
