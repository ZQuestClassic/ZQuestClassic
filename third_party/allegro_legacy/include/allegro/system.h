...
AL_LEGACY_ARRAY(char, allegro_id);
AL_LEGACY_ARRAY(char, allegro_error);
...
AL_LEGACY_VAR(int, os_type);
AL_LEGACY_VAR(int, os_version);
AL_LEGACY_VAR(int, os_revision);
AL_LEGACY_VAR(int, os_multitasking);
...
AL_LEGACY_FUNC(int, _install_allegro_version_check, (int system_id, int *errno_ptr,
   AL_LEGACY_METHOD(int, atexit_ptr, (AL_LEGACY_METHOD(void, func, (void)))), int version));

AL_LEGACY_INLINE(int, install_allegro, (int system_id, int *errno_ptr,
   AL_LEGACY_METHOD(int, atexit_ptr, (AL_LEGACY_METHOD(void, func, (void))))),
{
   return _install_allegro_version_check(system_id, errno_ptr, atexit_ptr, \
      MAKE_VERSION(ALLEGRO_LEGACY_VERSION, ALLEGRO_LEGACY_SUB_VERSION, ALLEGRO_LEGACY_WIP_VERSION));
})
...
AL_LEGACY_FUNC(void, check_cpu, (void));
...
AL_LEGACY_ARRAY(char, cpu_vendor);
AL_LEGACY_VAR(int, cpu_family);
AL_LEGACY_VAR(int, cpu_model);
AL_LEGACY_VAR(int, cpu_capabilities);
...
typedef struct SYSTEM_DRIVER
{
   ...
   AL_LEGACY_METHOD(void, created_bitmap, (struct BITMAP *bmp));
   AL_LEGACY_METHOD(struct BITMAP *, create_sub_bitmap, (struct BITMAP *parent, int x, int y, int width, int height));
   ...
   AL_LEGACY_METHOD(int, desktop_color_depth, (void));
   AL_LEGACY_METHOD(int, get_desktop_resolution, (int *width, int *height));
   AL_LEGACY_METHOD(void, get_gfx_safe_mode, (int *driver, struct GFX_MODE *mode));
   AL_LEGACY_METHOD(void, yield_timeslice, (void));
   AL_LEGACY_METHOD(void *, create_mutex, (void));
   AL_LEGACY_METHOD(void, destroy_mutex, (void *handle));
   AL_LEGACY_METHOD(void, lock_mutex, (void *handle));
   AL_LEGACY_METHOD(void, unlock_mutex, (void *handle));
   AL_LEGACY_METHOD(_DRIVER_INFO *, gfx_drivers, (void));
   AL_LEGACY_METHOD(_DRIVER_INFO *, digi_drivers, (void));
   AL_LEGACY_METHOD(_DRIVER_INFO *, midi_drivers, (void));
   AL_LEGACY_METHOD(_DRIVER_INFO *, keyboard_drivers, (void));
   AL_LEGACY_METHOD(_DRIVER_INFO *, mouse_drivers, (void));
   AL_LEGACY_METHOD(_DRIVER_INFO *, joystick_drivers, (void));
   AL_LEGACY_METHOD(_DRIVER_INFO *, timer_drivers, (void));
} SYSTEM_DRIVER;


AL_LEGACY_VAR(SYSTEM_DRIVER, system_none);
AL_LEGACY_VAR(SYSTEM_DRIVER *, system_driver);
AL_LEGACY_ARRAY(_DRIVER_INFO, _system_driver_list);
