...
AL_LEGACY_VAR(SYSTEM_DRIVER, system_macos);

/*******************************************/
/************** timer drivers **************/
/*******************************************/
#define TIMER_MACOS           AL_ID('M','C','O','S')
AL_LEGACY_VAR(TIMER_DRIVER, timer_macos);

/*******************************************/
/************ keyboard drivers *************/
/*******************************************/
#define KEYBOARD_MACOS       AL_ID('M','C','O','S')
AL_LEGACY_VAR(KEYBOARD_DRIVER, keyboard_macos);
#define KEYBOARD_ADB         AL_ID('M','A','D','B')
AL_LEGACY_VAR(KEYBOARD_DRIVER, keyboard_adb);

/*******************************************/
/************* mouse drivers ***************/
/*******************************************/
#define MOUSE_MACOS          AL_ID('M','C','O','S')
AL_LEGACY_VAR(MOUSE_DRIVER, mouse_macos);
#define MOUSE_ADB            AL_ID('M','A','D','B')
AL_LEGACY_VAR(MOUSE_DRIVER, mouse_adb);
...
AL_LEGACY_VAR(GFX_DRIVER,gfx_drawsprocket);
...
AL_LEGACY_VAR(DIGI_DRIVER, digi_macos);
