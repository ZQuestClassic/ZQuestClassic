...
#if defined ALLEGRO_LEGACY_HAVE_INTTYPES_H
   #include <inttypes.h>
#elif defined ALLEGRO_LEGACY_HAVE_STDINT_H
   #include <stdint.h>
#elif defined ALLEGRO_LEGACY_I386 && defined ALLEGRO_LEGACY_LITTLE_ENDIAN
   #ifndef ALLEGRO_LEGACY_GUESS_INTTYPES_OK
