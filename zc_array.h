...
public:
	...
	bool operator == ( const ZCArrayIterator& v ) const { return (_ptr == v._ptr); }
	bool operator != ( const ZCArrayIterator& v ) const { return (_ptr != v._ptr); }
	bool operator <  ( const ZCArrayIterator& v ) const { return (_ptr <  v._ptr); }
	bool operator >  ( const ZCArrayIterator& v ) const { return (_ptr >  v._ptr); }
	bool operator <= ( const ZCArrayIterator& v ) const { return (_ptr <= v._ptr); }
	...
	reference		 operator [] ( size_type _Index )		{ return( *(_ptr + _Index) ); }
	const_reference  operator [] ( size_type _Index ) const	{ return( *(_ptr + _Index) ); }

	ZCArrayIterator &operator ++ ()	{ ++_ptr; return *this;	}
	ZCArrayIterator &operator -- ()	{ --_ptr; return *this; }
	ZCArrayIterator  operator ++ (int)	{ pointer _Tmp = _ptr; _ptr++; return ZCArrayIterator(_Tmp); }
	ZCArrayIterator  operator -- (int)	{ pointer _Tmp = _ptr; _ptr--; return ZCArrayIterator(_Tmp); }

	ZCArrayIterator &operator += ( int _Offset ) { _ptr += _Offset; return *this; }
	ZCArrayIterator &operator -= ( int _Offset ) { _ptr -= _Offset; return *this; }
	ZCArrayIterator  operator +  ( int _Offset ) const { return ZCArrayIterator(_ptr + _Offset); }
	ZCArrayIterator  operator -  ( int _Offset ) const { return ZCArrayIterator(_ptr - _Offset); }
...
public:
	...
	reference StrictAt( size_type _X )									{ _BoundsExp(_X); return _ptr[ _X ]; }
	reference StrictAt( size_type _Y, size_type _X )					{ _BoundsExp(_X,_Y); return _ptr[ Offset(_Y, _X) ]; }
	reference StrictAt( size_type _Z, size_type _Y, size_type _X )	{ _BoundsExp(_X,_Y,_Z); return _ptr[ Offset(_Z, _Y, _X) ]; }
