...
public:
	...
	string toString();
	Opcode *clone() {return new OSetTrue(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OSetFalse(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OSetMore(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OSetLess(a->clone());}
};
...
public:
	string toString();
	Opcode *clone() {return new OWaitdraw();}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OTrace2Register(a->clone());}
};
...
public:
	string toString();
	Opcode *clone() {return new OTrace3();}
};
...
public:
	string toString();
	Opcode *clone() {return new OTrace4();}
};
...
public:
	string toString();
	Opcode *clone() {return new OTrace5Register();}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OTrace6Register(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OArcSinRegister(a->clone(), b->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OArcCosRegister(a->clone(), b->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OATanRegister(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OLog10Register(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OLogERegister(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OArraySize(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OCalcSplineRegister(a->clone(),b->clone());}
};
...
public:
	string toString();
	Opcode *clone() {return new OSetColorRegister();}
};
...
public:
	string toString();
	Opcode *clone() {return new OSetDepthRegister();}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OCollisionRectRegister(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OCollisionBoxRegister(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OCreateLWpnRegister(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OCreateEWpnRegister(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OLoadItemRegister(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OLoadItemDataRegister(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OLoadNPCRegister(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OLoadLWpnRegister(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OLoadEWpnRegister(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OGetSaveName(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OGetDMapName(a->clone(), b->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OGetDMapIntro(a->clone(), b->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OGetDMapTitle(a->clone(), b->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OSetSaveName(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OGetItemName(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OGetNPCName(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OGetMessage(a->clone(), b->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OMessageRegister(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OIsSolid(a->clone());}
};
...
public:
	string toString();
	Opcode *clone() {return new OSetSideWarpRegister();}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OLayerScreenRegister(a->clone(), b->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OLayerMapRegister(a->clone(), b->clone());}
};
...
public:
	string toString();
	Opcode *clone() {return new OTriggerSecrets();}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OIsValidItem(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OIsValidNPC(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OIsValidLWpn(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OIsValidEWpn(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OUseSpriteLWpn(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OUseSpriteEWpn(a->clone());}
};
...
public:
	string toString();
	Opcode *clone() {return new OSplineRegister();}
};
...
public:
	string toString();
	Opcode *clone() {return new ODrawCharRegister();}
};
...
public:
	string toString();
	Opcode *clone() {return new ODrawIntRegister();}
};
...
public:
	string toString();
	Opcode *clone() {return new OQuadRegister();}
};
...
public:
	string toString();
	Opcode *clone() {return new OTriangleRegister();}
};
...
public:
	string toString();
	Opcode *clone() {return new OQuad3DRegister();}
};
...
public:
	string toString();
	Opcode *clone() {return new OTriangle3DRegister();}
};
...
public:
	string toString();
	Opcode *clone() {return new OFastTileRegister();}
};
...
public:
	string toString();
	Opcode *clone() {return new OFastComboRegister();}
};
...
public:
	string toString();
	Opcode *clone() {return new OSetDepthBufferRegister();}
};
...
public:
	string toString();
	Opcode *clone() {return new OGetDepthBufferRegister();}
};
...
public:
	string toString();
	Opcode *clone() {return new OSetColorBufferRegister();}
};
...
public:
	string toString();
	Opcode *clone() {return new OGetColorBufferRegister();}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OCopyTileRegister(a->clone(),b->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OSwapTileRegister(a->clone(),b->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OClearTileRegister(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OAllocateMemRegister(a->clone(),b->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OAllocateGlobalMemImmediate(a->clone(),b->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OAllocateGlobalMemRegister(a->clone(),b->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new ODeallocateMemRegister(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new ODeallocateMemImmediate(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OGetScreenFlags(a->clone());}
};
...
public:
	...
	string toString();
	Opcode *clone() {return new OGetScreenEFlags(a->clone());}
};
