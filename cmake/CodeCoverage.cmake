...
function(setup_coverage_test_target target_name output_dir test_runner)
  ...
  add_custom_target(${target_name}
        ...
        COMMAND ${CODE_COVERAGE_GCOVR} -d --html-details ${output_dir}/index.html --json ${CMAKE_BINARY_DIR}/coverage.json -r ${CMAKE_SOURCE_DIR} -f ${CMAKE_SOURCE_DIR}/src --html-theme blue --html-title "Zelda Classic Coverage Report"
