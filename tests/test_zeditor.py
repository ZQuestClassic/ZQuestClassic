...
class TestZEditor(unittest.TestCase):
    ...
    def test_export_strings(self):
        ...
        self.assertEqual(
            tsv[2],
            '  IT\'S DANGEROUS TO GO      ALONE! TAKE THIS.	0	0	0	0	0	24	32	192	24	18	0	18	0	1	0	0	0	8 8 0 8	0	0	0	0	1	1	0	0	6	43	9	0	0	-1	7	0	0	-1	7	0	0	1	1',
        )
    ...
    def test_roundtrip_strings(self):
        ...
        self.run_zeditor(['-export-strings', src_qst, export1])
        self.run_zeditor(['-import-strings', work_qst, export1])
        self.run_zeditor(['-export-strings', work_qst, export2])
