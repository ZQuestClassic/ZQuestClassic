...
void LinkClass::init()
{
	...
	last_lens_id = 0; //should also init at -1, @Venrob. -Z
...
void LinkClass::checkstab()
{
    ...
    /*
    int quakescr = current_item_id(itype_quakescroll);
if ( quakescr >= 0 )
{
...
bool LinkClass::startwpn(int itemid)
{
    ...
    case itype_bomb:
    {
		...
		if ( quest_header_zelda_version > 0x250 || ( quest_header_zelda_version == 0x250 && quest_header_zelda_build > 31 ) )
		{
