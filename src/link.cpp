...
void LinkClass::checkhit()
{
	...
	int itemid = ((weapon*)(Lwpns.spr(i)))->parentitem;
        ...
        if((!((itemsbuf[itemid].family==itype_candle||itemsbuf[itemid].family==itype_book)&&(itemsbuf[itemid].flags & ITEM_FLAG3))) && (scriptcoldet&1) && (!superman || !get_bit(quest_rules,qr_FIREPROOFLINK2)))
        {
