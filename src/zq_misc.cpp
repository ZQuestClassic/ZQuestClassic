...
const char *flag_string[MAXFLAGS] =
{
    ...
    "161 Sideview Ladder",
    "162 Sideview Platform","163 Spawn No Enemies","164 Spawn All Enemies","165 Secrets->Next","166 mf166","167 mf167","168 mf168","169 mf169",
...
const char *combotype_help_string[cMAX] =
{
    ...
    "The player is warped via Tile Warp A if he steps on the bottom half of this combo.",
    "The player marches down into this combo and is warped via Tile Warp A if he steps on this. The combo's tile will be drawn above the player during this animation.",
    ...
    "If the 'Statues Shoot Fire' Screen Data flag is checked, an invisible fireball shooting enemy is spawned on this combo.",
    "The player's movement speed is reduced while he walks on this combo. Enemies will not be affected.",
    "While the player is standing on top of this, he will be moved upward at 1/4 of his normal walking speed (or some dir at a custom-set speed), until he collides with a solid combo.",
    "While the player is standing on top of this, he will be moved downward at 1/4 of his normal walking speed (or some dir at a custom-set speed), until he collides with a solid combo.",
    "While the player is standing on top of this, he will be moved leftward at 1/4 of his normal walking speed (or some dir at a custom-set speed), until he collides with a solid combo.",
    "While the player is standing on top of this, he will be moved rightward at 1/4 of his normal walking speed (or some dir at a custom-set speed), until he collides with a solid combo.",
    "The player is warped via Tile Warp A if he swims on this combo. Otherwise, this is identical to Water.",
    "The player is warped via Tile Warp A if he dives on this combo. Otherwise, this is identical to Water.",
    ...
    "The player is warped via Tile Warp A if he touches any part of this combo, but his on-screen position remains the same. Ground enemies can't enter.",
    ...
    "The player marches up into this combo and is warped via Tile Warp A if he steps on this. The combo's tile will be drawn above the player during this animation.",
    ...
    "Ripples sprites are drawn on the player when he walks on this combo. Also, Quake Hammer pounds are nullified by this combo.",
    ...
    "The player marches down into this combo and is warped via Tile Warp B if he steps on this. The combo's tile will be drawn above the player during this animation.",
    "The player marches down into this combo and is warped via Tile Warp C if he steps on this. The combo's tile will be drawn above the player during this animation.",
    "The player marches down into this combo and is warped via Tile Warp D if he steps on this. The combo's tile will be drawn above the player during this animation.",
    "The player is warped via Tile Warp B if he steps on the bottom half of this combo.",
    "The player is warped via Tile Warp C if he steps on the bottom half of this combo.",
    "The player is warped via Tile Warp D if he steps on the bottom half of this combo.",
    "The player is warped via Tile Warp B if he touches any part of this combo, but his on-screen position remains the same. Ground enemies can't enter.",
    "The player is warped via Tile Warp C if he touches any part of this combo, but his on-screen position remains the same. Ground enemies can't enter.",
    "The player is warped via Tile Warp D if he touches any part of this combo, but his on-screen position remains the same. Ground enemies can't enter.",
    "The player marches up into this combo and is warped via Tile Warp B if he steps on this. The combo's tile will be drawn above the player during this animation.",
    "The player marches up into this combo and is warped via Tile Warp C if he steps on this. The combo's tile will be drawn above the player during this animation.",
    "The player marches up into this combo and is warped via Tile Warp D if he steps on this. The combo's tile will be drawn above the player during this animation.",
    "The player is warped via Tile Warp B if he swims on this combo. Otherwise, this is identical to Water.",
    "The player is warped via Tile Warp C if he swims on this combo. Otherwise, this is identical to Water.",
    "The player is warped via Tile Warp D if he swims on this combo. Otherwise, this is identical to Water.",
    "The player is warped via Tile Warp B if he dives on this combo. Otherwise, this is identical to Water.",
    "The player is warped via Tile Warp C if he dives on this combo. Otherwise, this is identical to Water.",
    "The player is warped via Tile Warp D if he dives on this combo. Otherwise, this is identical to Water.",
    ...
    "Identical to Stairs [A], but the player will be warped as soon as he touches the edge of this combo.",
    "Identical to Stairs [B], but the player will be warped as soon as he touches the edge of this combo.",
    "Identical to Stairs [C], but the player will be warped as soon as he touches the edge of this combo.",
    "Identical to Stairs [D], but the player will be warped as soon as he touches the edge of this combo.",
    "Identical to Stairs [Random], but the player will be warped as soon as he touches the edge of this combo.",
