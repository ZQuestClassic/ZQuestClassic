...
enum
{
	...
	//46
	qr_LENIENT_SOLID_DAMAGE, qr_NO_SIDEVIEW_SOLID_DAMAGE, qr_DISABLE_F6,
	//DEEDEE SPOT
	//50
	...
	// 71
	qr_BROKEN_WATER_PASSIVE_DAMAGE, qr_BROKEN_SELF_TRIGGERING_TRIGGERS, qr_OLD_ITEM_HITBOXES, qr_SUBSCR_SELECTOR_USES_ITEM_HITBOX,
	qr_BROKEN_0_DAMAGE_BRANG_HSHOT, qr_PAUSE_ICE_SLIDING_WHILE_ATTACKING, qr_BROKEN_SPINTILE_COMBO_CHANGE, qr_LIGHT_RADIUS_IGNORE_HIT_OFFSETS,
	// 72
	qr_BROKEN_SV_SOLID_CONVEYORS, qr_ITEM_CONVEYORS_IGNORE_HITBOX, qr_ITEMS_HARDCODED_SIDEVIEW_HITBOX, qr_WEAPONS_HARDCODED_SIDEVIEW_HITBOX,
	qr_BROKEN_PUSHBLOCK_TRIGGER_GROUPS, qr_OLD_LAYER_DRAW_ORDER, qr_MAP_SPOILS_DARKROOMS, qr_BS_OW_IGNORES_MAP_ITEM,
	// 73
	qr_BROKEN_ENEMY_SIDEVIEW_PLATFORM_HITBOX, qr_RESPAWN_POINTS_HALF_GRID, qr_BROKEN_PLAYER_SOLIDPUSH, qr_SMARTDROPS_NOTHING,
	qr_OLD_BRIDGE_COMBO_COVER, qr_MINIMAP_VISITED_CHARTED, qr_ALLOW_JUMP_WHILE_CHARGING, qr_QUAKE_HAMMER_IN_AIR,
	// 74
	...
	// 75
	qr_BROKEN_SCC_MAP_ARGS, qr_OLD_LONG_SCC_ARGS, qr_STRINGS_DONT_SCROLL, qr_STRING_SEGMENTED_SCROLL,
	qr_SCRIPTS_SHARE_INITD, qr_OLD_210_HAMMER_POUND_REACH,
