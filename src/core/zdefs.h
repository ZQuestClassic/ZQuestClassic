...
#define V_MIDIS            5
#define V_CHEATS           1
#define V_SAVEGAME        53
#define V_COMBOALIASES     5
#define V_HEROSPRITES      16
#define V_SUBSCREEN        21
#define V_ITEMDROPSETS     2
#define V_FFSCRIPT         31
#define V_SFX              9
...
{	//These are the COMBO flags. -Z
	...
	//165
	mfSECRETSNEXT, mfNOMIRROR, mfUNSAFEGROUND_SENS, mfUNSAFEGROUND, mf169, mf170, mf171, mf172, mf173, mf174,
...
enum
{
	...
	pMESSAGESCROLLUP, pMESSAGESCROLLDOWN,
};
