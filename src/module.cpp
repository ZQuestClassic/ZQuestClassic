...
bool ZModule::init(bool d) //bool default
{
	...
	if ( d )
	{
		...
		const char map_flag_default_string[mfMAX][255] =
		{
			...
			"No Enemies", "No Ground Enemies", "General Purpose 1 (Scripts)", "General Purpose 02 (Scripts)", "General Purpose 03 (Scripts)", "General Purpose 04 (Scripts)", "General Purpose 05 (Scripts)", "Raft Bounce",
			 "Pushed", "General Purpose 06 (Scripts)", "General Purpose 07 (Scripts)", "General Purpose 08 (Scripts)", "General Purpose 09 (Scripts)", "General Purpose 10 (Scripts)", "General Purpose 11 (Scripts)", "General Purpose 12 (Scripts)",
