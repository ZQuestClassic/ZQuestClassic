...
namespace ZScript
{
	...
	public:
		...
		virtual DataType* resolve(ZScript::Scope& scope, CompileErrorHandler* errorHandler) override;
		virtual DataType const* baseType(ZScript::Scope& scope, CompileErrorHandler* errorHandler) override;
