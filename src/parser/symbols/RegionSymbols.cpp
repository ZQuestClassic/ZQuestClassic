...
static AccessorTable RegionTable[] =
{
	...
	{ "GetScreenIndexForComoboPos", 0,          ZTID_LONG,   -1,                           FL_INL,   { ZTID_REGION, ZTID_FLOAT }, {} },
	{ "GetScreenForComoboPos",      0,          ZTID_SCREEN, -1,                           FL_INL,   { ZTID_REGION, ZTID_FLOAT }, {} },
...
{
	//int32_t GetScreenIndexForComoboPos(region, int32_t)
	{
		Function* function = getFunction("GetScreenIndexForComoboPos");
	...
	//screendata GetScreenForComboPos(region, int32_t)
	{
