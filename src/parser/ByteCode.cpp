...
string ZScript::VarToString(int32_t ID)
{
	...
	//	case DMAPDATAJUMPLAYER: return "DMAPDATAJUMPLAYER";
		...
		case COMBODTRIGSWORDJINX: return "COMBODTRIGSWORDJINX";
		case COMBODTRIGITEMJINX: return "COMBODTRIGITEMJINX";
		case COMBODTRIGSTUN: return "COMBODTRIGSTUN";
		case COMBODTRIGBUNNY: return "COMBODTRIGBUNNY";
		case COMBODTRIGPUSHTIME: return "COMBODTRIGPUSHTIME";
