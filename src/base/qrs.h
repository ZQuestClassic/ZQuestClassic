...
enum
{
	...
	qr_CUSTOM_WEAPON_BROKEN_SIZE, qr_OLD_WEAPON_REFLECTION, qr_OLD_BROKEN_HERO_DEFENSES, qr_SWITCHHOOK_USES_HOOKSHOT_WEAPON,
	//58
	qr_OLD_ENEMY_DEFENSE_SCRIPT_ACCESS,
	//EMILY SPOT
	//60
