...
enum
{
	...
	qr_BROKEN_LIFTSWIM, qr_BROKEN_GENERIC_PUSHBLOCK_LOCKING, qr_BROKEN_EWFLAME_REFLECTING,
	//EMILY SPOT
	//60
	//CONNOR SPOT qr_ = 60*8,
	//70
	//MOOSH SPOT qr_ = 70*8,
	qr_OLD_SCRIPT_VOLUME = 70 * 8, qr_OLD_DMAP_INTRO_STRINGS, qr_SCRIPTDRAWSFROZENMSG,
