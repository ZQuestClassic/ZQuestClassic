...
enum
{
	...
	//57
	qr_EW_ROCKS_HARDCODED_BREAK_ON_SOLID, qr_IMPRECISE_WEAPON_SOLIDITY_CHECKS, qr_NO_STUNLOCK_IGNORE, qr_BROKEN_BLOCKHOLE_PITFALLS,
	qr_CUSTOM_WEAPON_BROKEN_SIZE, qr_OLD_WEAPON_REFLECTION, qr_OLD_SPRITE_FALL_DROWN, qr_OLD_TERMINAL_VELOCITY,
	//58
	qr_BETTER_PLAYER_JUMP_ANIM, qr_ARMOS_GRAVE_ON_LAYERS, qr_OLD_SCRIPT_LEVEL_GLOBAL_STATES, qr_BROKEN_ARMOS_GRAVE_BIGHITBOX_COLLISION,
	qr_HERO_DIVE_UNDER_LAYER_1, qr_CLASSIC_DRAWING_ORDER, qr_YSORT_SPRITES, qr_OLD_WEAPON_DRAW_ANIMATE_TIMING,
	//59
	qr_OLD_PIT_SENSITIVITY, qr_ACTIVE_SHIELD_PASSIVE_ROC_NO_SCRIPT, qr_MAP_BUTTON_CLOSES_SUBSCREEN, qr_ONLY_MARK_SCREENS_VISITED_IF_MAP_VIEWABLE,
	qr_ACTIVE_SUB_IGNORE_8PX, qr_MIRROR_PRISM_FFCS, qr_WEAPON_BETTER_SCREEN_EDGE_HITBOX, qr_DRAWCOMBO_IGNORES_FRAME,
	//60
	...
	// 71
	qr_BROKEN_WATER_PASSIVE_DAMAGE, qr_BROKEN_SELF_TRIGGERING_TRIGGERS,
