...
enum
{
	...
	//56
	qr_PUSHBLOCKS_FALL_IN_SIDEVIEW, qr_BROKEN_ICY_FLOOR_SIDEVIEW, qr_BROKEN_SYSTEM_COLORS____________NOT_IN_255, qr_WEAPONS_EXTRA_SPAWN_FRAME,
	qr_BROKEN_SCROLL_INSTEAD_OF_DROWN_FALL,
	//EMILY SPOT
	//60
	//CONNOR SPOT qr_ = 60*8,
	qr_SCRIPTS_6_BIT_COLOR____________NOT_IN_255 = 60*8,
	qr_BROKEN_SCRIPTS_SCROLLING_HERO_POSITION,
	qr_HIDE_BOTTOM_8_PIXELS,
	qr_BROKEN_SCRIPTS_BITMAP_DRAW_ORIGIN,
	qr_INVERTED_DARK_COMBO_TRIGGERS____________NOT_IN_255,
	qr_SCRIPTS_SCREEN_DRAW_LIGHT_NO_OFFSET____________NOT_IN_255,
