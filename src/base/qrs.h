...
enum
{
	...
	//56
	qr_PUSHBLOCKS_FALL_IN_SIDEVIEW, qr_BROKEN_ICY_FLOOR_SIDEVIEW, qr_BROKEN_SYSTEM_COLORS___NOT_IN_255, qr_WEAPONS_EXTRA_SPAWN_FRAME,
	qr_BROKEN_SCROLL_INSTEAD_OF_DROWN_FALL, qr_LIFTED_WEAPONS_RUN_SCRIPTS___NOT_IN_255, qr_BOMB_BOOMS_CLEAR_SCRIPTS___NOT_IN_255, qr_BETTER_ENGINE_AUTOROTATE___NOT_IN_255,
	//57
	qr_EW_ROCKS_HARDCODED_BREAK_ON_SOLID___NOT_IN_255, qr_IMPRECISE_WEAPON_SOLIDITY_CHECKS___NOT_IN_255, qr_NO_STUNLOCK_IGNORE___NOT_IN_255, qr_BROKEN_BLOCKHOLE_PITFALLS,
	qr_CUSTOM_WEAPON_BROKEN_SIZE, qr_OLD_WEAPON_REFLECTION___NOT_IN_255, qr_OLD_SPRITE_FALL_DROWN, qr_OLD_TERMINAL_VELOCITY___NOT_IN_255,
	//58
	qr_BETTER_PLAYER_JUMP_ANIM___NOT_IN_255, qr_ARMOS_GRAVE_ON_LAYERS___NOT_IN_255, qr_OLD_SCRIPT_LEVEL_GLOBAL_STATES___NOT_IN_255, qr_BROKEN_ARMOS_GRAVE_BIGHITBOX_COLLISION___NOT_IN_255,
	qr_HERO_DIVE_UNDER_LAYER_1___NOT_IN_255, qr_CLASSIC_DRAWING_ORDER___NOT_IN_255, qr_YSORT_SPRITES___NOT_IN_255, qr_OLD_WEAPON_DRAW_ANIMATE_TIMING___NOT_IN_255,
	//59
	qr_OLD_PIT_SENSITIVITY, qr_ACTIVE_SHIELD_PASSIVE_ROC_NO_SCRIPT, qr_MAP_BUTTON_CLOSES_SUBSCREEN__NOT_IN_255, qr_ONLY_MARK_SCREENS_VISITED_IF_MAP_VIEWABLE__NOT_IN_255,
	qr_ACTIVE_SUB_IGNORE_8PX, qr_MIRROR_PRISM_FFCS___NOT_IN_255, qr_WEAPON_BETTER_SCREEN_EDGE_HITBOX___NOT_IN_255, qr_DRAWCOMBO_IGNORES_FRAME,
	//60
	//CONNOR SPOT qr_ = 60*8,
	qr_SCRIPTS_6_BIT_COLOR___NOT_IN_255 = 60*8,
	qr_BROKEN_SCRIPTS_SCROLLING_HERO_POSITION,
	qr_HIDE_BOTTOM_8_PIXELS,
	qr_BROKEN_SCRIPTS_BITMAP_DRAW_ORIGIN,
	qr_INVERTED_DARK_COMBO_TRIGGERS___NOT_IN_255,
	qr_SCRIPTS_SCREEN_DRAW_LIGHT_NO_OFFSET___NOT_IN_255,
	qr_ROPE_ENEMIES_SPEED_NOT_CONFIGURABLE,
	qr_BROKEN_FFC_WRAP_CHANGERS = 61*8+2,
	qr_TURN_WHILE_CHARGING_HAMMER,
	//70
	//EMILY SPOT qr_ = 70*8,
	qr_OLD_SCRIPT_VOLUME = 70 * 8, qr_OLD_DMAP_INTRO_STRINGS, qr_SCRIPTDRAWSFROZENMSG, qr_BROKEN_SIDEVIEW_SPRITE_JUMP,
	qr_DRAWTILE_TALL_DRAWS_WRAP_POORLY, qr_BUGGY_MULTIPLE_WIND, qr_NO_DEATH_EVENTS_FOR_SEGMENTED_ENEMY_CORES, qr_BROKEN_COPYCAT_SELF_TRIGGER,
	// 71
	qr_BROKEN_WATER_PASSIVE_DAMAGE___NOT_IN_255, qr_BROKEN_SELF_TRIGGERING_TRIGGERS, qr_OLD_ITEM_HITBOXES___NOT_IN_255, qr_SUBSCR_SELECTOR_USES_ITEM_HITBOX___NOT_IN_255,
	qr_BROKEN_0_DAMAGE_BRANG_HSHOT, qr_PAUSE_ICE_SLIDING_WHILE_ATTACKING__NOT_IN_255, qr_BROKEN_SPINTILE_COMBO_CHANGE, qr_LIGHT_RADIUS_IGNORE_HIT_OFFSETS,
	// 73 (groups 72-74 not in 2.55; keep slots aligned with main)
	qr_BROKEN_ENEMY_SIDEVIEW_PLATFORM_HITBOX = 73*8,
	qr_RESPAWN_POINTS_HALF_GRID = 73*8+1,
	qr_BROKEN_PLAYER_SOLIDPUSH = 73*8+2,
	qr_SMARTDROPS_NOTHING = 73*8+3,
	qr_BROKEN_PUSHBLOCK_TRIGGER_GROUPS = 72*8+4,
	qr_BS_OW_IGNORES_MAP_ITEM = 72*8+7,
	qr_KNOCKBACK_THROUGH_PLATFORMS = 74*8+4,
	qr_BROKEN_SIDEVIEW_SOLID_FFC_COLLISION = 74*8+5,
	qr_CHESTS_SIGNS_LOCKBLOCKS_ABOVE_2 = 74*8+3,
	qr_BROKEN_LARGE_ARMOS_ANIM = 74*8+7,
	qr_BROKEN_SCC_MAP_ARGS = 75*8,
	qr_OLD_210_HAMMER_POUND_REACH = 75*8+5,
	...
	//86
	qr_ZS_NO_NEG_ARRAY, qr_PRINTF_NO_0FILL,
