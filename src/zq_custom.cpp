...
//263m--works as [96]   
 ...
 { jwin_check_proc,        6,     97,     95,      9,    vc(14),                 vc(1),                   0,       0,           1,    0, (void *) "Flags[5]",                        NULL,   NULL                  },
    ...
    //323
    { jwin_check_proc,        6,       47,     95,      9,    vc(14),                 vc(1),                   0,       0,           1,    0, (void *) "Large Collision Rectangle",                        NULL,   NULL                  },
    ...
    { jwin_check_proc,        6,       137,    95,      9,    vc(14),                 vc(1),                   0,       0,           1,    0, (void *) "Invisible",                        NULL,   NULL                  },
    { jwin_check_proc,        6,       147,    95,      9,    vc(14),                 vc(1),                   0,       0,           1,    0, (void *) "Triggers Screen State ST_SP_ITEM",                        NULL,   NULL                  },
    { jwin_check_proc,        6,       157,    95,      9,    vc(14),                 vc(1),                   0,       0,           1,    0, (void *) "Triggers Screen Secrets",                        NULL,   NULL                  },
    { jwin_check_proc,        6,       167,    95,      9,    vc(14),                 vc(1),                   0,       D_DISABLED,  1,    0, (void *) "--",                        NULL,   NULL                  },
