...
enum { sstACTIVE, sstPASSIVE, sstOVERLAY, sstMAP, sstMAX };
...
#define SUBSCR_COUNTER_MAXCTR         SUBSCRFLAG_SPEC_03
#define SUBSCR_COUNTER_FRACTION       SUBSCRFLAG_SPEC_04
#define SUBSCR_NUMFLAG_COUNTER        4
...
#define SUBSCR_BTNCOUNTER_MAXCTR      SUBSCRFLAG_SPEC_03
#define SUBSCR_BTNCOUNTER_FRACTION    SUBSCRFLAG_SPEC_04
#define SUBSCR_NUMFLAG_BTNCOUNTER     4
