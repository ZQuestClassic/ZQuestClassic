				...
				Column(
					...
					Row(
						...
						Frame(title = "Stats",
							Rows_Columns<2, 5>(hAlign = 1.0,
								...
								NumberField(&local_guyref.dp, 0, 32767, 4),
								Label(text = "W. Damage:", hAlign = 1.0),
								NumberField(&local_guyref.wdp, 0, 32767, 4),
								...
								Label(text = "Rate:", hAlign = 1.0, rightPadding = 0_px),
								NumberField(&local_guyref.rate, 0, MAXRATE, 4),
								Label(text = "Homing:", hAlign = 1.0, rightPadding = 0_px),
								NumberField(&local_guyref.homing, 0, MAXHOMING, 4),
								Label(text = "Step:", hAlign = 1.0, rightPadding = 0_px),
								NumberField(&local_guyref.step, 0, MAXSTEP, 4),
								Label(text = "Boss Pal:", hAlign = 1.0, rightPadding = 0_px),
					...
					Row(
						Frame(title = "Misc", hAlign = 1.0, fitParent = true,
							Column(
								Rows<4>(rowSpacing = 0.5_em, vAlign = 1.0,
									...
									Label(text = "F Rate:", hAlign = 1.0, rightPadding = 0_px),
		...
		TabRef(name = "Defenses", TabPanel(
			...
			TabRef(name = "Defenses 1", Row(
				Columns<10>(hAlign = 1.0, vAlign = 1.0, rowSpacing = 0.5_em,
					Label(text = "Brang Defense", hAlign = 1.0, rightPadding=0_px),
					Label(text = "Bomb Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Super Bomb Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Arrow Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Fire Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Wand Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Magic Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Hookshot Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Hammer Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Sword Defense", hAlign = 1.0, rightPadding = 0_px),
			...
			TabRef(name = "Defenses 2", Row(
				Columns<10>(hAlign = 1.0, vAlign = 1.0, rowSpacing = 0.5_em,
					Label(text = "Sword Beam Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Ref. Beam Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Ref. Magic Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Ref. Fireball Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Ref. Rock Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Stomp Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Byrna Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Quake Hammer Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Whistle Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "SwitchHook Defense", hAlign = 1.0, rightPadding = 0_px),
			...
			TabRef(name = "Script", Row(
				Columns<10>(hAlign = 1.0, rowSpacing = 0.5_em,
					Label(text = "Custom Weapon 1 Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Custom Weapon 2 Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Custom Weapon 3 Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Custom Weapon 4 Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Custom Weapon 5 Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Custom Weapon 6 Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Custom Weapon 7 Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Custom Weapon 8 Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Custom Weapon 9 Defense", hAlign = 1.0, rightPadding = 0_px),
					Label(text = "Custom Weapon 10 Defense", hAlign = 1.0, rightPadding = 0_px),
		...
		TabRef(name = "Flags", TabPanel(
			...
			TabRef(name = "Basic Flags", Row(
				Column(hAlign = 1.0, fitParent = true,
					...
					GuyFlag(guy_ignore_kill_all, "Ignored by 'Kill All Enemies' effects"),
			...
			TabRef(name = "Basic", Column(
				Frame(title = "Projectile", hAlign = 1.0, fitParent = true,
					Rows<3>(hAlign = 1.0, rowSpacing = 0.5_em,
						...
						INFOBTN("The weapontype that is fired."),
						//
			...
			TabRef(name = "Basic", Column(
				...
				Frame(title = "Animation", hAlign = 1.0, fitParent = true,
					Row(hAlign = 1.0,
						...
						//
						Label(text = "Death Animation:", hAlign = 1.0, rightPadding = 0_px),
						DropDownField(&death_type, list_deathtype),
						INFOBTN("Animation used while dying.")
						//
					)
				)
			))
