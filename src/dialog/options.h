...
private:
	enum optionVal
	{
		...
		OPT_TOOLTIP_TIMER, OPT_MAPCURSOR, OPT_ALWAYS_SHOW_CURSOR,
		//
		...
		OPT_FIRSTFONT,
		OPT_LARGEFONT_DIALOG = OPT_FIRSTFONT,
		OPT_LARGEFONT_GUI, OPT_LARGEFONT_TITLE,
		OPT_LARGEFONT_FAVCMD, OPT_LARGEFONT_TEXTBOX,
		OPT_LARGEFONT_TTIP, OPT_LARGEFONT_INFO,
