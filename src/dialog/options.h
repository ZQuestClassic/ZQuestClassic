...
private:
	enum optionVal
	{
		...
		OPT_SNAPFORMAT, OPT_KBREPDEL, OPT_KBREPRATE, OPT_CMB_CURS_COL,
		OPT_TPG_CURS_COL, OPT_CPG_CURS_COL,
		//
		OPT_CURS_LARGE,
		...
		OPT_HIDEMOUSE, OPT_COMPILEONSAVE, OPT_SHOW_FAV_COMBO_MODES,
		...
		OPT_COMPACTFONT_SCALE_DIALOG, OPT_COMPACTFONT_SCALE_GUI,
