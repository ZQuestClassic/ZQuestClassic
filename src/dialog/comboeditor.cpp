				...
				TabRef(name = "Attribs 2", Column(
					...
					Row(
						Button(text = "Misc Weapon Data",
							onPressFunc = [&]()
							{
								call_weap_data_editor(local_comboref.misc_weap_data.get(),
									is_misc_lweapon(local_comboref), true);
								local_comboref.misc_weap_data.normalize();
							}),
						...
						Rows<3>(
							...
							Row(padding = 0_px, colSpan = 3,
								Button(text = "Lift Weapon Data",
									onPressFunc = [&]()
									{
										call_weap_data_editor(local_comboref.lift_weap_data.get(), true);
										local_comboref.lift_weap_data.normalize();
									}),
