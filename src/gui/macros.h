...
inline void allowChild(const std::shared_ptr<parent>&, const std::shared_ptr<child>&)
{
	...
	ZCGUI_REQUIRE_PARENT(::GUI::TabPanel, ::GUI::Tab, "Tabs can only be added to TabPanels.");
	ZCGUI_REQUIRE_CHILD(::GUI::TabPanel, ::GUI::Tab, "Only Tabs can be added to TabPanels.");
}
