...
enum
{
	...
	qr_ITEMCOMBINE_CONTINUOUS, qr_SCC_ITEM_COMBINES_ITEMS, qr_SCROLLING_KILLS_CHARGE,
...
enum // used for gamedata ITEMS
{
	...
	itype_mirror, itype_switchhook, itype_itmbundle, itype_progressive_itm,
	/*
	itype_templast,
