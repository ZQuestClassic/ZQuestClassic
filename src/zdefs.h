...
#define ZELDA_VERSION_STR   "AEternal (v2.55) Alpha 35"                    //version of the program as presented in text
#define IS_BETA             -35                        //is this a beta? (1: beta, -1: alpha)
#define VERSION_BETA        35	
#define DATE_STR            "8th October, 2019, 09:15GMT"
#define ZELDA_ABOUT_STR 	    "ZC Player 'AEternal', Alpha 35"
