...
#define ZELDA_VERSION_STR   "AEternal (v2.55) Alpha 18"                    //version of the program as presented in text
#define IS_BETA             -17                         //is this a beta? (1: beta, -1: alpha)
#define VERSION_BETA        17
#define DATE_STR            "15th April, 2019"
#define ZELDA_ABOUT_STR 	    "ZC Player 'AEternal', Alpha 18"
