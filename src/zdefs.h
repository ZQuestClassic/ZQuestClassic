...
#define VERSION_BUILD       43                              //build number of this version
//31 == 2.53.0 , leaving 32-39 for bugfixes, and jumping to 40. 
#define ZELDA_VERSION_STR   "AEternal (v2.55) Alpha 20"                    //version of the program as presented in text
#define IS_BETA             -20                         //is this a beta? (1: beta, -1: alpha)
#define VERSION_BETA        20
#define DATE_STR            "22nd April, 2019"
#define ZELDA_ABOUT_STR 	    "ZC Player 'AEternal', Alpha 20"
