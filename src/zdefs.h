...
#define ZELDA_VERSION_STR   "Omnius, 2.53 Beta 32"               //version of the program as presented in text
#define IS_BETA             32                         //is this a beta? (1: beta, -1: alpha)
#define DATE_STR            "14th January, 2019"
...
//emulation patches
enum { emuITEMPERSEG, emuGRIDCOLLISION, emuOLDTRIBBLES, emu190LINKSPRITES,emuCOPYSWIMSPRITES };
