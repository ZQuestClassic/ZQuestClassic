...
#define ZELDA_VERSION_STR   "AEternal (v2.55) Alpha 10"                    //version of the program as presented in text
#define IS_BETA             -10                         //is this a beta? (1: beta, -1: alpha)
#define VERSION_BETA        10
#define DATE_STR            "21st December, 2018"
#define ZELDA_ABOUT_STR 	    "ZC Player 'AEternal', Alpha 10"
