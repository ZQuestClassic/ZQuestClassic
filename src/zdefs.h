...
#define VERSION_BUILD       51                              //build number of this version
...
enum
{
	...
	qr_DUNGEON_DMAPS_PERM_SECRETS, qr_STRING_FRAME_OLD_WIDTH_HEIGHT, qr_LADDER_PITS,
	...
	qr_IDIOTICSHASHNEXTSECRETBUGSUPPORT, qr_STEP_IS_FLOAT,
	//85
