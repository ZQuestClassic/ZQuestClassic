...
#define ZELDA_VERSION_STR   "2.54 Alpha 18"                    //version of the program as presented in text
#define IS_BETA             -18                              //is this a beta? (1: beta, -1: alpha)
#define VERSION_BETA        00017
#define DATE_STR            "21st November, 2017"
