...
public:
	...
	bounded_map<word, int> item_cooldown {MAXITEMS, 0};
private:
...
public:
	...
	void pre_scrolling_script(int32_t scrolldir, int32_t cx, int32_t sx, int32_t sy, bool end_frames);
	void run_scrolling_script(int32_t scrolldir, int32_t cx, int32_t sx, int32_t sy, bool end_frames, bool waitdraw);
	void run_scrolling_genscr_timing(int32_t scrolldir, int32_t cx, int32_t sx, int32_t sy, bool end_frames, int32_t timing);
