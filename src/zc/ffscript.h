...
enum //ScrollingData indexes
{
	...
	SCROLLDATA_NPX, SCROLLDATA_NPY, SCROLLDATA_OPX, SCROLLDATA_OPY,
	SCROLLDATA_NEW_REGION_WIDTH, SCROLLDATA_NEW_REGION_HEIGHT,
	SCROLLDATA_OLD_REGION_WIDTH, SCROLLDATA_OLD_REGION_HEIGHT,
	...
	SCROLLDATA_NRX, SCROLLDATA_NRY,
	SCROLLDATA_ORX, SCROLLDATA_ORY,
	SZ_SCROLLDATA
};
...
#define RESRVD_VAR_EMILY38      0x14E9
#define RESRVD_VAR_EMILY39      0x14EA
#define RESRVD_VAR_EMILY40      0x14EB
#define RESRVD_VAR_EMILY41      0x14EC
#define RESRVD_VAR_EMILY42      0x14ED
