...
const char* scripting_get_zasm_register_context_string(int reg)
{
	switch (reg)
	{
		...
		case GAME_SAVEMENU_F6: return "Game->SaveMenuF6";
		case GAME_SAVEMENU_GAMEOVER: return "Game->SaveMenuGameOver";
		...
		case SAVEMENU_BGCSET: return "save_menu::BGCSet";
		case SAVEMENU_BGCOLOR: return "save_menu::BGColor";
		case SAVEMENU_BGTILE: return "save_menu::BGTile";
		case SAVEMENU_BGTH: return "save_menu::BGTileHeight";
		case SAVEMENU_BGTW: return "save_menu::BGTileWidth";
		case SAVEMENU_CLOSE_FLASH_RATE: return "save_menu::CloseFlashRate";
		case SAVEMENU_CLOSE_FRAMES: return "save_menu::CloseFrames";
		case SAVEMENU_OPT_COLOR_TEXT: return "save_menu::Colors[]";
		case SAVEMENU_CURSORCSET: return "save_menu::CursorCSet";
		case SAVEMENU_CURSORTILE: return "save_menu::CursorTile";
		case SAVEMENU_FLAGS: return "save_menu::Flags[]";
		case SAVEMENU_OPT_FONTS: return "save_menu::Fonts[]";
		case SAVEMENU_OPT_FRZSCR: return "save_menu::FrozenScripts[]";
		...
		case SAVEMENU_SFX_CHOOSE: return "save_menu::SFXChoose";
		case SAVEMENU_SFX_CURSOR: return "save_menu::SFXCursor";
		case SAVEMENU_TEXT_ALIGN: return "save_menu::TextAlign";
		case SAVEMENU_TEXT_BOX_ALIGN: return "save_menu::TextBoxAlign";
		case SAVEMENU_VSPACE: return "save_menu::VSpace";
		case SAVEMENU_OPTX: return "save_menu::X";
		case SAVEMENU_OPTY: return "save_menu::Y";
		...
		case SUBWIDGREQ_DMAP_FLOOR: return "subscreenwidget::RequiredDMapFloors[]";
		case SUBWIDGREQ_DMAP_LEVEL: return "subscreenwidget::RequiredDMapLevels[]";
		case SUBWIDGREQ_DMAP: return "subscreenwidget::RequiredDMaps[]";
		...
		case SUBWIDGREQ_LEVEL_STATE_LEVEL: return "subscreenwidget::RequiredLStateLevel";
		case SUBWIDGREQ_LEVEL_STATE: return "subscreenwidget::RequiredLStates[]";
		case SUBWIDGREQ_MAP: return "subscreenwidget::RequiredMaps[]";
		case SUBWIDGREQOWNITEMS: return "subscreenwidget::RequiredOwnedItems[]";
		case SUBWIDGREQ_SCRSTATE_EXSTATE: return "subscreenwidget::RequiredScreenExStates[]";
		case SUBWIDGREQ_SCRSTATE_MAP: return "subscreenwidget::RequiredScreenStateMap";
		case SUBWIDGREQ_SCRSTATE_SCREEN: return "subscreenwidget::RequiredScreenStateScreen";
		case SUBWIDGREQ_SCRSTATE_STATE: return "subscreenwidget::RequiredScreenStates[]";
		case SUBWIDGREQ_SCREEN: return "subscreenwidget::RequiredScreens[]";
...
const char* scripting_get_zasm_command_context_string(ASM_DEFINE command)
{
	switch (command)
	{
		...
		case LOADSAVEMENU: return "Game->LoadSaveMenu()";
		...
		case SAVEMENU_ADD_OPT: return "save_menu::AddOption()";
		case SAVEMENU_GETNAME: return "save_menu::GetName()";
		case SAVEMENU_OPT_GET_STRING: return "save_menu::GetString()";
		case SAVEMENU_OPEN: return "save_menu::Open()";
		case SAVEMENU_REMOVE_OPT: return "save_menu::RemoveOption()";
		case SAVEMENU_SETNAME: return "save_menu::SetName()";
		case SAVEMENU_OPT_SET_STRING: return "save_menu::SetString()";
		case SAVEMENU_SWAP_OPT: return "save_menu::SwapOptions()";
		...
		case OBJ_OWN_DIR: return "sprite::Own()";
		case OBJ_OWN_STACK: return "sprite::Own()";
		case OBJ_OWN_RNG: return "sprite::Own()";
		case OBJ_OWN_ARRAY: return "sprite::OwnArray()";
		case OBJ_OWN_CLASS: return "sprite::OwnObject()";
