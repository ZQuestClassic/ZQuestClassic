	...
	if (get_qr(qr_SHALLOW_SENSITIVE))
	{
		if (HeroZ() == 0 && HeroFakeZ() == 0 && HeroAction() != swimming && HeroAction() != sideswimming && HeroAction() != sideswimhit && HeroAction() != sideswimattacking && HeroAction() != isdiving && HeroAction() != drowning)
		{
			...
			*/
			...
			return !(iswaterex_z3(FFORCOMBO(HeroX()+11,HeroY()+15), currmap, currscr, -1, HeroX()+11,HeroY()+15, false, false, true, true)
			&& iswaterex_z3(FFORCOMBO(HeroX()+4,HeroY()+15), currmap, currscr, -1, HeroX()+4,HeroY()+15, false, false, true, true)
			&& iswaterex_z3(FFORCOMBO(HeroX()+11,HeroY()+9), currmap, currscr, -1, HeroX()+11,HeroY()+9, false, false, true, true)
			&& iswaterex_z3(FFORCOMBO(HeroX()+4,HeroY()+9), currmap, currscr, -1, HeroX()+4,HeroY()+9, false, false, true, true));
		}
		return true;
	}
	else
