...
bool _walkflag(zfix x,zfix y,int32_t cnt,zfix const& switchblockstate);
bool _effectflag(int32_t x,int32_t y,int32_t cnt, int32_t layer = -1, bool notLink = false);
bool _walkflag(zfix x,zfix y,int32_t cnt, mapscr* m);
bool _walkflag(zfix x,zfix y,int32_t cnt, mapscr* m, mapscr* s1, mapscr* s2);
bool _walkflag_layer(zfix x,zfix y,int32_t cnt, mapscr* m);
