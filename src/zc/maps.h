...
void clear_dmaps();
int32_t count_dmaps();
int32_t isdungeon(int32_t dmap = -1, int32_t screen = -1);
...
void unsetmapflag_mi(mapscr* scr, int32_t mi2, int32_t flag, bool anyflag=false);
void unsetmapflag_mi(int32_t mi2, int32_t flag, bool anyflag=false);
