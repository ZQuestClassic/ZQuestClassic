...
void hidden_entrance(int32_t tmp, bool high16only=false, int32_t single=-1);
...
void do_layer_new(BITMAP *bmp, int32_t type, int32_t map, int32_t scr, int32_t layer, mapscr* basescr, int32_t x, int32_t y, bool drawprimitives=false);
void do_layer_scr(BITMAP *bmp, int32_t type, int32_t map, int32_t scr, int32_t layer, mapscr* basescr, mapscr* layerscr, int32_t x, int32_t y, bool drawprimitives=false);
