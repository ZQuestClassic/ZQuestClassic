...
extern int32_t global_frame,cur_map,dlevel,scrolling_hero_screen,scrolling_map,scrolling_dmap,scrolling_destdmap;
...
extern int32_t newscr_clk,cur_dmap,fadeclk;
