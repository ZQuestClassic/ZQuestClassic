...
heroanimate_skip_liftwpn:;
	...
	auto tmp_shield = refreshActiveShield();
	if(active_shield_id != tmp_shield)
	{
		active_shield_id = tmp_shield;
		flushTilemodCache();
	}
