...
void HeroClass::scrollscr_butgood(int32_t scrolldir, int32_t destscr, int32_t destdmap)
{
	...
	for_every_nearby_screen_during_scroll(old_temporary_screens, [&](mapscr* myscr, int map, int scr, int draw_dx, int draw_dy) {
