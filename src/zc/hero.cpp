...
void HeroClass::draw(BITMAP* dest)
{
	...
	
	{
		...
		if(action != casting && action != sideswimcasting)
		{
			...
			bool inwater = iswaterex_z3(MAPCOMBO(x+4,y+9), currmap, currscr, -1, x+4, y+9, true, false)  && iswaterex_z3(MAPCOMBO(x+4,y2), currmap, currscr, -1, x+4, y2, true, false) &&  iswaterex_z3(MAPCOMBO(x+11,y+9), currmap, currscr, -1, x+11, y+9, true, false) && iswaterex_z3(MAPCOMBO(x+11,y2), currmap, currscr, -1, x+11, y2, true, false);
