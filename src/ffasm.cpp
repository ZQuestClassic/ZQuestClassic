...
script_command command_list[NUMCOMMANDS+1]=
{
    ...
    { "__RESERVED_FOR_BITMAPEXR",          0,   0,   0,   0},
    { "__RESERVED_FOR_QUAD2R",                0,   0,   0,   0},
    { "__RESERVED_FOR_WAVYIN",			   0,   0,   0,   0},
    { "__RESERVED_FOR_WAVYOUT",			   0,   0,   0,   0},
    { "__RESERVED_FOR_ZAPIN",			   0,   0,   0,   0},
    { "__RESERVED_FOR_ZAPOUT",			   0,   0,   0,   0},
    { "__RESERVED_FOR_OPENWIPE",			   0,   0,   0,   0},
    { "FREE0x00F1",			   0,   0,   0, 0  },
    { "FREE0x00F2",			   0,   0,   0, 0},  
    { "FREE0x00F3",			   0,   0,   0,0},  
    ...
    { "__RESERVED_FOR_GREYSCALEON",			   0,   0,   0,   0},
    { "__RESERVED_FOR_GREYSCALEOFF",			   0,   0,   0,   0},
...
script_variable variable_list[]=
{
    ...
    { "DMAPMAP",            DMAPMAP,             0,             0 },
     { "__RESERVED_FOR_GAMETHROTTLE",         GAMETHROTTLE,            0,             0 },
	...
	{ "IDATAID",         IDATAID,            0,             0 },
        { "__RESERVED_FOR_LINKEXTEND",         LINKEXTEND,            0,             0 },
	{ "__RESERVED_FOR_NPCSCRDEFENSED",        NPCSCRDEFENSED,         0,             0 },
	{ "__RESERVED_FOR_SETLINKTILE",              SETLINKTILE,                 0,             0 },
	{ "__RESERVED_FOR_SETLINKEXTEND",           SETLINKEXTEND,            0,             0 },
	{ "__RESERVED_FOR_SIDEWARPSFX",           SIDEWARPSFX,            0,             0 },
	{ "__RESERVED_FOR_PITWARPSFX",           PITWARPSFX,            0,             0 },
	{ "__RESERVED_FOR_SIDEWARPVISUAL",           SIDEWARPVISUAL,            0,             0 },
	{ "__RESERVED_FOR_PITWARPVISUAL",           PITWARPVISUAL,            0,             0 },
	{ "__RESERVED_FOR_GAMESETA",           GAMESETA,            0,             0 },
	{ "__RESERVED_FOR_GAMESETB",           GAMESETB,            0,             0 },
	{ "__RESERVED_FOR_SETITEMSLOT",           SETITEMSLOT,            0,             0 },
	{ "__RESERVED_FOR_LINKITEMB",           LINKITEMB,            0,             0 },
	{ "__RESERVED_FOR_LINKITEMA",           LINKITEMA,            0,             0 },
	{ "__RESERVED_FOR_LINKWALKTILE",           LINKWALKTILE,            0,             0 }, //Walk sprite
	{ "__RESERVED_FOR_LINKFLOATTILE",           LINKFLOATTILE,            0,             0 }, //float sprite
	{ "__RESERVED_FOR_LINKSWIMTILE",           LINKSWIMTILE,            0,             0 }, //swim sprite
	{ "__RESERVED_FOR_LINKDIVETILE",           LINKDIVETILE,            0,             0 }, //dive sprite
	{ "__RESERVED_FOR_LINKSLASHTILE",           LINKSLASHTILE,            0,             0 }, //slash sprite
	{ "__RESERVED_FOR_LINKJUMPTILE",           LINKJUMPTILE,            0,             0 }, //jump sprite
	{ "__RESERVED_FOR_LINKCHARGETILE",           LINKCHARGETILE,            0,             0 }, //charge sprite
	{ "__RESERVED_FOR_LINKSTABTILE",           LINKSTABTILE,            0,             0 }, //stab sprite
	{ "__RESERVED_FOR_LINKCASTTILE",           LINKCASTTILE,            0,             0 }, //casting sprite
	{ "__RESERVED_FOR_LINKHOLD1LTILE",           LINKHOLD1LTILE,            0,             0 }, //hold1land sprite
	{ "__RESERVED_FOR_LINKHOLD2LTILE",           LINKHOLD2LTILE,            0,             0 }, //hold2land sprite
	{ "__RESERVED_FOR_LINKHOLD1WTILE",           LINKHOLD1WTILE,            0,             0 }, //hold1water sprite
	{ "__RESERVED_FOR_LINKHOLD2WTILE",           LINKHOLD2WTILE,            0,             0 }, //hold2water sprite
	{ "__RESERVED_FOR_LINKPOUNDTILE",           LINKPOUNDTILE,            0,             0 }, //hammer pound sprite
	{ "__RESERVED_FOR_LINKSWIMSPD",           LINKSWIMSPD,            0,             0 },
	{ "__RESERVED_FOR_LINKWALKANMSPD",           LINKWALKANMSPD,            0,             0 },
	{ "__RESERVED_FOR_LINKANIMTYPE",           LINKANIMTYPE,            0,             0 },
	{ "__RESERVED_FOR_LINKINVFRAME",           LINKINVFRAME,            0,             0 },
	{ "__RESERVED_FOR_LINKCANFLICKER",           LINKCANFLICKER,            0,             0 },
	{ "__RESERVED_FOR_LINKHURTSFX",           LINKHURTSFX,            0,             0 },
	{ "__RESERVED_FOR_NOACTIVESUBSC",           NOACTIVESUBSC,            0,             0 },
	{ "__RESERVED_FOR_LWPNRANGE",         LWPNRANGE,            0,             0 },
	{ "__RESERVED_FOR_ZELDAVERSION",         ZELDAVERSION,            0,             0 },
	{ "__RESERVED_FOR_ZELDABUILD",         ZELDABUILD,            0,             0 },
	{ "__RESERVED_FOR_ZELDABETA",         ZELDABETA,            0,             0 },
	{ "__RESERVED_FOR_NPCINVINC",         NPCINVINC,            0,             0 },
	{ "__RESERVED_FOR_NPCSUPERMAN",         NPCSUPERMAN,            0,             0 },
	{ "__RESERVED_FOR_NPCHASITEM",         NPCHASITEM,            0,             0 },
	{ "__RESERVED_FOR_NPCRINGLEAD",         NPCRINGLEAD,            0,             0 },
	{ "IDATAFRAME",         IDATAFRAME,            0,             0 },
	{ "__RESERVED_FOR_ITEMACLK",         ITEMACLK,            0,             0 },
	{ "__RESERVED_FOR_FFCID",         FFCID,            0,             0 },
	{ "IDATAATTRIB",         IDATAATTRIB,            0,             0 },
	{ "IDATASPRITE",         IDATASPRITE,            0,             0 },
	{ "IDATAFLAGS",         IDATAFLAGS,            0,             0 },
	{ "__RESERVED_FOR_DMAPLEVELPAL",         DMAPLEVELPAL,          0,             0 },
	{ "__RESERVED_FOR_ITEMPTR",         ITEMPTR,          0,             0 },
	{ "__RESERVED_FOR_NPCPTR",         NPCPTR,          0,             0 },
	{ "__RESERVED_FOR_LWPNPTR",         LWPNPTR,          0,             0 },
	{ "__RESERVED_FOR_EWPNPTR",         EWPNPTR,          0,             0 },
	{ "__RESERVED_FOR_SETSCREENDOOR",           SETSCREENDOOR,            0,             0 },
	{ "__RESERVED_FOR_SETSCREENENEMY",           SETSCREENENEMY,            0,             0 },
	{ "__RESERVED_FOR_GAMEMAXMAPS",           GAMEMAXMAPS,              0,             0 },
	{ "__RESERVED_FOR_CREATELWPNDX", CREATELWPNDX, 0, 0 },
	{ "__RESERVED_FOR_SCREENFLAG",     SCREENFLAG,        0,             0 },
	{ "__RESERVED_FOR_BUTTONPRESS",     BUTTONPRESS,        0,             0 },
	{ "__RESERVED_FOR_BUTTONINPUT",     BUTTONINPUT,        0,             0 },
	{ "__RESERVED_FOR_BUTTONHELD",     BUTTONHELD,        0,             0 },
	{ "__RESERVED_FOR_KEYPRESS",     KEYPRESS,        0,             0 },
	{ "__RESERVED_FOR_READKEY",     READKEY,        0,             0 },
	{ "__RESERVED_FOR_JOYPADPRESS",     JOYPADPRESS,        0,             0 },
	{ "__RESERVED_FOR_DISABLEDITEM",         DISABLEDITEM,            0,             0 },
	{ "__RESERVED_FOR_LINKDIAG",           LINKDIAG,            0,             0 },
	{ "__RESERVED_FOR_LINKBIGHITBOX",           LINKBIGHITBOX,            0,             0 },
	{ "__RESERVED_FOR_LINKEATEN", LINKEATEN, 0, 0 },
	{ "__RESERVED_FOR_LINKRETSQUARE", LINKRETSQUARE, 0, 0 },
	{ "__RESERVED_FOR_LINKWARPSOUND", LINKWARPSOUND, 0, 0 },
	{ "__RESERVED_FOR_PLAYPITWARPSFX", PLAYPITWARPSFX, 0, 0 },
	{ "__RESERVED_FOR_WARPEFFECT", WARPEFFECT, 0, 0 },
	{ "__RESERVED_FOR_PLAYWARPSOUND", PLAYWARPSOUND, 0, 0 },
	{ "__RESERVED_FOR_LINKUSINGITEM", LINKUSINGITEM, 0, 0 },
	{ "__RESERVED_FOR_LINKUSINGITEMA", LINKUSINGITEMA, 0, 0 },
	{ "__RESERVED_FOR_LINKUSINGITEMB", LINKUSINGITEMB, 0, 0 },
