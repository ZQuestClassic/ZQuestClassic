...
enum ASM_DEFINE
{
	...
	LITTRIANGLER,	//0x00FC
	LITQUAD3DR,	//0x00FD
	LITTRIANGLE3DR,	//0x00FE
	LITFASTTILER,	//0x00FF
	LITFASTCOMBOR,	//0x0100
	LITSTRINGR,	//0x0101
	LITLAYERR,	//0x0102
	LITSCREENR,	//0x0103
	GAMETHROTTLE, 	  //0x0104
	...
	PRESSFI, 	  //0x010F
	PRESSFQ, 	  //0x0110
	GAMEHEARTBEEP,    //0x0111
	ONCONVEY,	  //0x0112
	ACTTIMEDWARP,	  //0x0113
	GOFAST,		  //0x0114
	GETZCVERSION,	  //0x0115
	LENSOFTRUTH,	  //0x0116
	ITEMCLASSTILE, 	  //0x0117
	ITEMCLASSFLAGS,	  //0x0118 
	ITEMCLASSCSET, 	  //0x0119
	ITEMCLASSMISCD,   //0x011A
	ITEMCLASSDD,	  //0x011B
	ITEMCLASSID,	  //0x011C
	SCREENDOORDD,	  //0x011D
	LINKEXTEND,	  //0x011E
	LINKOTILE,	  //0x011F
	ITEMCLASSINITD,   //0x0120
    NUMCOMMANDS           //0x0121
};
...
//Defines for ZoriaRPG 2016 Additions

//Game
#define	SCREENDOORDD	0x10BA
#define	GAMETHROTTLE	0x10BB
#define	GAMEPAUSED	0x10BC
#define	GAMESHOWFPS	0x10BD
#define	GAMESHOWPAL	0x10BE
#define	GAMECLICKFREEZE2	0x10BF
#define	GAMEPLAYING	0x10C0
#define	GAMEDEBUG	0x10C1
#define	GAMEDEBUGON	0x10C2
#define	PRESSF12	0x10C3
#define	PRESSF11	0x10C4
#define	PRESSF5 	0x10C5
#define	PRESSFI		0x10C6
#define	PRESSFQ		0x10C7
#define	GAMEHEARTBEEP	0x10C8
#define	ONCONVEY	0x10C9
#define	ACTTIMEDWARP	0x10CA
#define	GOFAST		0x10CB
#define	GETZCVERSION	0x10CC
#define	LENSOFTRUTH	0x10CD

//Itemclass - We'll move these to the reserved spots when working. 
#define	ITEMCLASSTILE	0x10CE
#define	ITEMCLASSFLAGS 	0x10CF
#define	ITEMCLASSCSET	0x10D0
#define	ITEMCLASSMISCD	0x10D1
#define	ITEMCLASSDD	0x10D2
#define	ITEMCLASSID	0x10D3
#define ITEMCLASSINITD	0x10D4

//Link - We'll move these to the reserved spots when working. 
#define	LINKEXTEND	0x10D5
#define	LINKOTILE	0x10D6
