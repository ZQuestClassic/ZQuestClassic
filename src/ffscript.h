...
enum ASM_DEFINE
{
    ...
    GETFFCSCRIPT,         //0x00E8
    BITMAPEXR,	//0x00E9
    __RESERED_FOR_QUAD2R, //0x00EA
    __RESERED_FOR_WAVYIN, //0x00EB
    __RESERED_FOR_WAVYOUT, //0x00EC
    __RESERED_FOR_ZAPIN, //0x00ED
    __RESERED_FOR_ZAPOUT, //0x00EF
    __RESERED_FOR_OPENWIPE, //0x00F0
    FREE0x00F1, //0x00F1 was SETLINKTILE
    FREE0x00F2, //0x00F2 was SETLINKEXTEND
    FREE0x00F3, //0x00F3 was GETLINKEXTEND
   __RESERED_FOR_ SETMESSAGE,			//0x00F4
    __RESERED_FOR_SETDMAPNAME,			//0x00F5
    __RESERED_FOR_SETDMAPTITLE,			//0x00F5
    __RESERED_FOR_SETDMAPINTRO,			//0x00F7
    __RESERED_FOR_GREYSCALEON,			//0x00F8
    __RESERED_FOR_GREYSCALEOFF,			//0x00F9
    __RESERED_FOR_ENDSOUNDR,           //0x00FA
    __RESERED_FOR_ENDSOUNDV,           //0x00FB
    __RESERED_FOR_PAUSESOUNDR, 	//0x00FC
    __RESERED_FOR_PAUSESOUNDV,	//0x00FD
    __RESERED_FOR_RESUMESOUNDR,	//0x00FE
    __RESERED_FOR_RESUMESOUNDV,	//0x00FF
    __RESERED_FOR_PAUSEMUSIC,		//0x0100
   __RESERED_FOR_RESUMEMUSIC,	//0x0101
    __RESERED_FOR_LWPNARRPTR,	//0x0102
    __RESERED_FOR_EWPNARRPTR,	//0x0103
    __RESERED_FOR_ITEMARRPTR,	//0x0104
    __RESERED_FOR_IDATAARRPTR,	//0x0105
    __RESERED_FOR_FFCARRPTR,	//0x0106
    __RESERED_FOR_BOOLARRPTR,	//0x0107
    __RESERED_FOR_NPCARRPTR,	//0x0108
    __RESERED_FOR_LWPNARRPTR2,	//0x0109
    __RESERED_FOR_EWPNARRPTR2,	//0x0110
    __RESERED_FOR_ITEMARRPTR2,	//0x0111
    __RESERED_FOR_IDATAARRPTR2,	//0x0112
    __RESERED_FOR_FFCARRPTR2,	//0x0113
    __RESERED_FOR_BOOLARRPTR2,	//0x0114
    __RESERED_FOR_NPCARRPTR2,	//0x0115
    __RESERED_FOR_ARRAYSIZEB,            //0x0116
    __RESERED_FOR_ARRAYSIZEF,            //0x0117 
    __RESERED_FOR_ARRAYSIZEN,            //0x0118
    __RESERED_FOR_ARRAYSIZEL,            //0x0119
    __RESERED_FOR_ARRAYSIZEE,            //0x011A
    __RESERED_FOR_ARRAYSIZEI,            //0x011B
    __RESERED_FOR_ARRAYSIZEID,            //0x011C
    __RESERED_FOR_POLYGONR,		//0x011D
    __RESERED_FOR_POLYGON3DR,		//0x011E
    __RESERED_FOR_SETRENDERSOURCE,	//0x011F
    __RESERED_FOR_CREATEBITMAP,	//0x0120
    __RESERED_FOR_PIXELARRAYR,	//0x0121
    __RESERED_FOR_TILEARRAYR,		//0x0122
    __RESERED_FOR_COMBOARRAYR,	//0x0123
    RES0000,		//0x0124
    RES0001,		//0x0125
    RES0002,		//0x0126
    RES0003,		//0x0127
    ...
    RES000E,		//0x0132
    RES000F,		//0x0133
    __RESERED_FOR_CREATELWPN2VV,            //0x0134
    __RESERED_FOR_CREATELWPN2VR,            //0x0135
    __RESERED_FOR_CREATELWPN2RV,            //0x0136
    __RESERED_FOR_CREATELWPN2RR,            //0x0137
   __RESERED_FOR_GETSCREENDOOR, //0x0138
   __RESERED_FOR_GETSCREENENEMY, //0x0139
    __RESERED_FOR_PAUSESFX,
    __RESERED_FOR_RESUMESFX,
    __RESERED_FOR_CONTINUESFX,
    __RESERED_FOR_ADJUSTSFX,
    //__RESERED_FOR_GETSCREENFLAG, //0x013A
    NUMCOMMANDS           //0x013B
};
...
//LINKWARPMUSIC
#define __RESERED_FOR_LINKUSINGITEM             0x024D
#define __RESERED_FOR_LINKUSINGITEMA             0x024E
#define __RESERED_FOR_LINKUSINGITEMB             0x024F
#define __RESERED_FOR_PLAYWARPSOUND             0x0250
#define __RESERED_FOR_WARPEFFECT             0x0251
#define __RESERED_FOR_PLAYPITWARPSFX             0x0252
#define __RESERED_FOR_LINKEATEN             0x0253
#define __RESERED_FOR_LINKEXTEND             0x0254
...
#define __RESERED_FOR_LWPNRANGE             0x0272
...
#define __RESERED_FOR_NPCSUPERMAN            0x02E3
#define __RESERED_FOR_NPCHASITEM            0x02E4
#define __RESERED_FOR_NPCRINGLEAD            0x02E5
#define __RESERED_FOR_NPCINVINC            0x02E6
...
#define __RESERED_FOR_GAMETHROTTLE	     0x10B9
...
#define __RESERED_FOR_NPCSCRDEFENSED 0x10DA

#define __RESERED_FOR_SETLINKEXTEND 0x10DB
#define __RESERED_FOR_SETLINKTILE 0x10DC
#define __RESERED_FOR_SIDEWARPSFX 0x10DD
#define __RESERED_FOR_PITWARPSFX 0x10DE
#define __RESERED_FOR_SIDEWARPVISUAL 0x10DF
#define __RESERED_FOR_PITWARPVISUAL 0x10F0
#define __RESERED_FOR_GAMESETA 0x10F1
#define __RESERED_FOR_GAMESETB 0x10F2
#define __RESERED_FOR_SETITEMSLOT 0x10F3
#define __RESERED_FOR_BUTTONPRESS 0x10F4
#define __RESERED_FOR_BUTTONINPUT 0x10F5
#define __RESERED_FOR_BUTTONHELD 0x10F6
#define __RESERED_FOR_KEYPRESS 0x10F7
#define __RESERED_FOR_READKEY 0x10F8
#define __RESERED_FOR_JOYPADPRESS 0x10F9
#define __RESERED_FOR_DISABLEDITEM 0x10FA
...
#define __RESERED_FOR_LINKITEMB 0x1104
#define __RESERED_FOR_LINKITEMA 0x1105
#define __RESERED_FOR_LINKWALKTILE 0x1106
#define 	__RESERED_FOR_LINKFLOATTILE 0x1107
#define 	__RESERED_FOR_LINKSWIMTILE 0x1108
#define 	__RESERED_FOR_LINKDIVETILE 0x1109
#define 	__RESERED_FOR_LINKSLASHTILE 0x110A
#define 	__RESERED_FOR_LINKJUMPTILE 0x110B
#define 	__RESERED_FOR_LINKCHARGETILE 0x110C
#define 	__RESERED_FOR_LINKSTABTILE 0x110D
#define 	__RESERED_FOR_LINKCASTTILE 0x110E
#define 	__RESERED_FOR_LINKHOLD1LTILE 0x110F
#define 	__RESERED_FOR_LINKHOLD2LTILE 0x1110
#define 	__RESERED_FOR_LINKHOLD1WTILE 0x1111
#define 	__RESERED_FOR_LINKHOLD2WTILE 0x1112
#define 	__RESERED_FOR_LINKPOUNDTILE 0x1113
#define __RESERED_FOR_LINKSWIMSPD 0x1114
#define __RESERED_FOR_LINKWALKANMSPD 0x1115
#define __RESERED_FOR_LINKANIMTYPE 0x1116
#define __RESERED_FOR_LINKINVFRAME 0x1117
#define __RESERED_FOR_LINKCANFLICKER 0x1118
#define __RESERED_FOR_LINKHURTSFX 0x1119
#define __RESERED_FOR_NOACTIVESUBSC 0x111A
#define __RESERED_FOR_ZELDAVERSION 0x111B
#define __RESERED_FOR_ZELDABUILD 0x111C
#define __RESERED_FOR_ZELDABETA 0x111D
#define __RESERED_FOR_FFCID 0x111E
#define __RESERED_FOR_DMAPLEVELPAL 0x111F
#define __RESERED_FOR_ITEMINDEX 0x1120
#define __RESERED_FOR_LWPNINDEX 0x1121
#define __RESERED_FOR_EWPNINDEX 0x1122
#define __RESERED_FOR_NPCINDEX 0x1123
#define __RESERED_FOR_ITEMPTR 0x1124
#define __RESERED_FOR_NPCPTR 0x1125
#define __RESERED_FOR_LWPNPTR 0x1126
#define __RESERED_FOR_EWPNPTR 0x1127


#define __RESERED_FOR_SETSCREENDOOR 0x1128
#define __RESERED_FOR_SETSCREENENEMY 0x1129
#define __RESERED_FOR_GAMEMAXMAPS 0x112A
#define __RESERED_FOR_CREATELWPNDX 0x112B
#define __RESERED_FOR_SCREENFLAG 0x112C
