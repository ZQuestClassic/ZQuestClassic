			...
			tabPanel = TabPanel(
				...
				TabRef(name = "ZC Player", Row(framed = true,
					...
					Rows<3>(fitParent = true,
						...
						CONFIG_DROPDOWN_I("Snapshot Scale:", App::zelda,"zeldadx","snapshot_scale",1,snapshotScaleList,"The scale of snapshots"),
				...
				TabRef(name = "ZC Editor", Row(framed = true,
					...
					Rows<3>(fitParent = true,
						...
						CONFIG_DROPDOWN_I("Snapshot Scale:", App::zquest,"zquest","snapshot_scale",1,snapshotScaleList,"The scale of snapshots"),
