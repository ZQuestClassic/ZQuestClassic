			...
			tabPanel = TabPanel(
				...
				TabRef(name = "ZC Player", Row(framed = true,
					...
					Rows<2>(fitParent = true,
						...
						CONFIG_CHECKBOX_I("Optimize ZASM",App::zelda,"zeldadx","optimize_zasm",1,"Optimize ZASM (zscript bytecode). Script heavy quests are known to run 2x more efficiently with this enabled."),
