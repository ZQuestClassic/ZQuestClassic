			...
			TabPanel(
				...
				TabRef(name = "ZC Player", Row(framed = true,
					Rows<2>(fitParent = true,
						...
						CONFIG_CHECKBOX("Skip Title",App::zelda,"zeldadx","skip_title",1),
						...
						CONFIG_CHECKBOX_I("Lock Aspect Ratio On Resize",App::zelda,"zeldadx","drag_aspect",0,"Makes any changes to the window size by dragging get snapped to ZC's default (4:3) aspect ratio."),
						...
						CONFIG_CHECKBOX_I("Linear Scaling",App::zelda,"zeldadx","scaling_mode",1,"Use linear scaling when upscaling the window. If off, the default is nearest-neighbor scaling"),
						...
						CONFIG_CHECKBOX_I("Replay Debug",App::zelda,"zeldadx","replay_debug",0,"Record debug information when making a .zplay file")
					),
				...
				TabRef(name = "ZQ Creator", Row(framed = true,
					Rows<2>(fitParent = true,
						...
						CONFIG_CHECKBOX("Mouse Scroll",App::zquest,"zquest","mouse_scroll",1),
						CONFIG_CHECKBOX("Overwrite Protection",App::zquest,"zquest","overwrite_prevention",1),
						...
						CONFIG_CHECKBOX_I("Show Ruleset Dialog on New Quest",App::zquest,"zquest","rulesetdialog",1,"On creating a 'New' quest, automatically pop up the 'Pick Ruleset' menu. (This can be found any time at 'Quest->Options->Pick Ruleset')"),
					...
					Rows<2>(fitParent = true,
						...
						CONFIG_CHECKBOX_I("Lock Aspect Ratio On Resize",App::zquest,"zquest","drag_aspect",0,"Makes any changes to the window size by dragging get snapped to ZQuest's default (4:3) aspect ratio."),
