...
void do_dev_qrs_zscript_command(std::string const& fname)
{
	static std::map<int, std::string> qr_const_names = {
		...
		{ qr_RESPAWN_POINTS_HALF_GRID, "qr_RESPAWN_POINTS_HALF_GRID" },
		...
		{ qr_PAUSE_ICE_SLIDING_WHILE_ATTACKING, "qr_PAUSE_ICE_SLIDING_WHILE_ATTACKING" },
		...
		{ qr_OLD_LAYER_DRAW_ORDER, "qr_OLD_LAYER_DRAW_ORDER" },
		...
		{ qr_OLD_ITEM_HITBOXES, "qr_OLD_ITEM_HITBOXES" },
		{ qr_SUBSCR_SELECTOR_USES_ITEM_HITBOX, "qr_SUBSCR_SELECTOR_USES_ITEM_HITBOX" },
		{ qr_BUGGY_MULTIPLE_WIND, "qr_BUGGY_MULTIPLE_WIND" },
		{ qr_NO_DEATH_EVENTS_FOR_SEGMENTED_ENEMY_CORES, "qr_NO_DEATH_EVENTS_FOR_SEGMENTED_ENEMY_CORES" },
		{ qr_DRAWTILE_TALL_DRAWS_WRAP_POORLY, "qr_DRAWTILE_TALL_DRAWS_WRAP_POORLY" },
		...
		{ qr_LIGHT_RADIUS_IGNORE_HIT_OFFSETS, "qr_LIGHT_RADIUS_IGNORE_HIT_OFFSETS" },
		{ qr_BROKEN_PUSHBLOCK_TRIGGER_GROUPS, "qr_BROKEN_PUSHBLOCK_TRIGGER_GROUPS" },
		{ qr_MAP_SPOILS_DARKROOMS, "qr_MAP_SPOILS_DARKROOMS" },
		{ qr_BS_OW_IGNORES_MAP_ITEM, "qr_BS_OW_IGNORES_MAP_ITEM" },
		{ qr_BROKEN_ENEMY_SIDEVIEW_PLATFORM_HITBOX, "qr_BROKEN_ENEMY_SIDEVIEW_PLATFORM_HITBOX" },
		{ qr_BROKEN_PLAYER_SOLIDPUSH, "qr_BROKEN_PLAYER_SOLIDPUSH" },
		{ qr_OLD_BRIDGE_COMBO_COVER, "qr_OLD_BRIDGE_COMBO_COVER" },
		{ qr_MINIMAP_VISITED_CHARTED, "qr_MINIMAP_VISITED_CHARTED" },
		...
		{ qr_BRIDGES_ABOVE_2, "qr_BRIDGES_ABOVE_2" },
		{ qr_CHESTS_SIGNS_LOCKBLOCKS_ABOVE_2, "qr_CHESTS_SIGNS_LOCKBLOCKS_ABOVE_2" },
		{ qr_KNOCKBACK_THROUGH_PLATFORMS, "qr_KNOCKBACK_THROUGH_PLATFORMS" },
		{ qr_BROKEN_SIDEVIEW_SOLID_FFC_COLLISION, "qr_BROKEN_SIDEVIEW_SOLID_FFC_COLLISION" },
		{ qr_OLD_SUMMONER_COUNTS, "qr_OLD_SUMMONER_COUNTS" },
		...
		{ qr_SCRIPTS_SHARE_INITD, "qr_SCRIPTS_SHARE_INITD" },
		{ qr_OLD_210_HAMMER_POUND_REACH, "qr_OLD_210_HAMMER_POUND_REACH" },
		{ qr_BROKEN_FFC_WRAP_CHANGERS, "qr_BROKEN_FFC_WRAP_CHANGERS" },
		{ qr_TURN_WHILE_CHARGING_HAMMER, "qr_TURN_WHILE_CHARGING_HAMMER" },
		{ qr_DISABLE_F6, "qr_DISABLE_F6" },
	};
