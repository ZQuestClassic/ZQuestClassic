...
int32_t parse_script_section(char const* combuf, char const* const* argbufs, ffscript& zasm_cmd, int32_t &retcode, std::vector<int32_t> *vptr = nullptr, std::string *sptr = nullptr);
