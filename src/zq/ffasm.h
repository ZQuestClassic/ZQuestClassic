...
int32_t parse_script_section(char *combuf, char *arg1buf, char *arg2buf, script_data **script, int32_t com, int32_t &retcode, std::vector<int32_t> *vptr = nullptr, std::string *sptr = nullptr);
