...
echo Copying '\Release' - zelda.exe, zquest.exe, zscript.exe, zlauncher.exe, zcsound.dll...
echo Copying '\Release' - zelda.exe, zquest.exe, zscript.exe, zlauncher.exe, zcsound.dll...>>%log%
