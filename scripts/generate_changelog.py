...
if args.generate_cherrypicks:
    ...
    # TODO: find commits w/ "cherry picked from commit" (haven't been using the -x option yet...)
    ...
    for sha in shas_seen:
        ...
        commits_same_content.append((sha, subject))
    ...
    for sha, subject in commits_3:
        if sha not in shas_seen and subject in commits_255_subjects:
