...
def build_locally(revision: Revision, channel: str):
	...
	if archives.get_release_commit_count('0f162d21d47cec49da6276120959be8393c4f80a') <= revision.commit_count < archives.get_release_commit_count('68fd510de75f14b57221e677c7b361df3dee493c'):
		raise Exception('cannot build this range')

	# Don't know how to build before cmake.
	if revision.commit_count < archives.get_release_commit_count('43313872ea176fa01a015bc09b30cbb6ea638fde'):
	...
	if revision.commit_count >= archives.get_release_commit_count('5432f8ca67bfe371ba7407838a73d455ea75131b'):
		cmake_generator_args = ['-G', 'Visual Studio 17 2022']
		build_folder += '_vs2022'
	elif revision.commit_count >= archives.get_release_commit_count('7ab5d08254f22c3bc6d67ae3ccaafe1e664d59d4'):
	...
	if revision.commit_count < archives.get_release_commit_count('a7bc1e8f88cd283c9d4dbba39520fe4f23295c59'):
...
def backfill(channel: str):
	...
	revs = [r for r in revs if r.commit_count >= archives.get_release_commit_count('a7bc1e8f88cd283c9d4dbba39520fe4f23295c59')]
